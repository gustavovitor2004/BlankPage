    ...
    <div className="min-h-screen flex items-center justify-center" style={{ background: 'var(--bg)' }}>
      ...
      <div className="w-full max-w-sm px-6 animate-fade-in">
        <div className="text-center mb-10">
          ...
          <p className="text-sm mt-1" style={{ color: 'var(--text-3)' }}>Comece a escrever hoje</p>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                required
                minLength={6}
                className="w-full px-4 py-3 rounded-lg text-sm outline-none pr-11"
                style={{
                  background: 'var(--surface)',
                  color: 'var(--text)',
                  border: '1px solid var(--border)',
        ...
        <p className="text-center text-sm mt-6" style={{ color: 'var(--text-3)' }}>
          Já tem conta?{' '}
          <Link href="/login" className="underline underline-offset-2" style={{ color: 'var(--text-2)' }}>
            Entrar
          </Link>
        </p>
      </div>
